...
func renderIntent(draft Draft) string {
	...
	b.WriteString("# Generated by gatemole bootstrap.\n")
	b.WriteString("# Review before relying on this contract.\n")
	b.WriteString("# Gatemole used repo signals; it did not infer product intent.\n\n")
	writeScalar(&b, "version", "gatemole.intent.v0")
	...
	writeList(&b, "runtime_metrics", []string{"gatemole.gate.decision"}, nil)
...
func writeGeneratedComment(b *strings.Builder, obligation Obligation) {
	...
	b.WriteString("  #   by: gatemole.bootstrap\n")
